...
export const metadata: Metadata = {
  title: 'Terms & Conditions | Abroad Simplified',
  description:
    'Read the Terms and Conditions for using the Abroad Simplified AI-powered study abroad platform. Understand your rights and responsibilities.',
  alternates: {
    canonical: 'https://abroadsimplified.com/terms',
  },
};
