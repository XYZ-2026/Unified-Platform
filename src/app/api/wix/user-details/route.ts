...
export async function POST(request: Request) {
  try {
          ...
          body: JSON.stringify({
            dataCollection: {
              ...
              fields: [
                ...
                { key: 'percentage', type: 'TEXT', displayName: 'Percentage Score' },
                { key: 'gpaScale', type: 'TEXT', displayName: 'GPA Scale' },
                { key: 'gpaWeighted', type: 'TEXT', displayName: 'Weighted GPA' },
                { key: 'country', type: 'TEXT', displayName: 'Country' },
                { key: 'city', type: 'TEXT', displayName: 'City' },
                { key: 'school', type: 'TEXT', displayName: 'School / Institution' },
    ...
    const mergedPayload = {
      ...
      percentage: body.percentage !== undefined ? body.percentage : (existingData.percentage || ''),
      gpaScale: body.gpaScale !== undefined ? body.gpaScale : (existingData.gpaScale || ''),
      ...
      city: body.city !== undefined ? body.city : (existingData.city || ''),
      ...
      school: body.school !== undefined ? body.school : (body.highSchool !== undefined ? body.highSchool : (existingData.school || existingData.highSchool || '')),
      highSchool: body.highSchool !== undefined ? body.highSchool : (body.school !== undefined ? body.school : (existingData.highSchool || existingData.school || '')),
