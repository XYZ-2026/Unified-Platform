            ...
            {filteredUnis.map((uni) => (
              ...
              >
                <div className="px-5 pt-5 pb-5 flex flex-col flex-1">
                  ...
                  {/* University name */}
                  <h3 className="text-[15px] sm:text-[16px] font-bold text-[#111827] leading-snug mb-1">
                    {uni.name}
                  </h3>
                  ...
                  {/* Popular Programs */}
                  <div className="mb-5">
                    <p className="text-[10px] text-[#D1D5DB] uppercase tracking-[0.14em] font-bold mb-2">
                      Popular Programs
                    </p>
                    <div className="flex flex-wrap gap-1.5">
                      {uni.programs.slice(0, 3).map((p) => (
                        <span
                          key={p}
                          className="text-[11px] bg-white border border-[#E5E7EB] text-[#374151] px-2.5 py-0.5 rounded-full font-medium hover:border-[#690B1B]/30 hover:text-[#690B1B] transition-colors cursor-default"
                        >
                          {p}
                        </span>
                      ))}
