          ...
          {sidebarCollapsed ? (
            ...
            >
              <div className="w-[36px] h-[36px] rounded-[10px] shadow-xs overflow-hidden shrink-0">
                <Image src="/logo.png" alt="Abroad Simplified Logo" width={36} height={36} className="w-full h-full object-cover group-hover:opacity-10 transition-opacity" />
              </div>
            ...
            <>
              <Link href="/" className="flex items-center gap-2.5 min-w-0 flex-1 overflow-hidden">
                <div className="w-[38px] h-[38px] rounded-[11px] shadow-[0_4px_16px_rgba(105,11,27,0.2)] overflow-hidden shrink-0">
                  <Image src="/logo.png" alt="Abroad Simplified Logo" width={38} height={38} className="w-full h-full object-cover" />
                </div>
      ...
      <div className={`flex-1 flex flex-col min-w-0 overflow-x-hidden transition-all duration-300 ${
        ...
        <header className="h-[60px] sm:h-[76px] px-3 sm:px-5 md:px-8 bg-white border-b border-[#E7E2DE] flex items-center justify-between sticky top-0 z-30">
          <div className="flex items-center gap-2 sm:gap-3 min-w-0">
            ...
            <Link href="/dashboard" className="md:hidden flex items-center gap-2 min-w-0">
              <div className="w-[32px] h-[32px] rounded-[10px] shadow-[0_4px_12px_rgba(105,11,27,0.18)] overflow-hidden shrink-0">
                <Image src="/logo.png" alt="Abroad Simplified Logo" width={32} height={32} className="w-full h-full object-cover" />
              </div>
          ...
          <div className="flex items-center gap-1.5 sm:gap-2 md:gap-3 shrink-0">
            <button
              type="button"
              className="hidden xl:flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-[#EBF4FB] border border-[#0088CB]/20 text-[#0088CB] text-[12px] font-bold hover:bg-[#0088CB]/10 transition-all"
            >
            ...
            <button
              type="button"
              className="hidden sm:flex relative p-1.5 sm:p-2 rounded-full border border-[#E7E2DE] bg-white text-[#555555] hover:text-[#690B1B] hover:border-[#690B1B]/30 transition-all shrink-0 cursor-pointer"
            ...
            <Link
              ...
              className="flex items-center sm:pl-2 sm:border-l sm:border-[#E7E2DE] shrink-0"
        ...
        {/* PAGE CONTENT ROUTE */}
        <main className="pb-20 sm:pb-24 md:pb-8 flex-1">
          {children}
        </main>

        {/* MOBILE BOTTOM NAVIGATION BAR */}
        <nav
          className="md:hidden fixed bottom-0 left-0 right-0 z-40 bg-white/95 backdrop-blur-xl border-t border-[#E7E2DE] shadow-[0_-4px_24px_rgba(0,0,0,0.08)] flex items-stretch"
